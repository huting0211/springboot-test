...
var Demo = function () {
    ...
    var setColor = function (color) {
        ...
        if (typeof Cookies !== "undefined") {
            Cookies.set('theme-color', color_);
        }
    };

    var setColorChecked = function (color) {
    ...
    return {
        ...
        init: function() {
            ...
            if (typeof Cookies !== "undefined") {
                var layoutStyle = Cookies.get('layout-style-option');
                if (layoutStyle == undefined)
                    layoutStyle = "rounded";
                setThemeStyle(layoutStyle);
                $('.theme-panel .layout-style-option').val(layoutStyle);

                var color = Cookies.get('theme-color');
                if (color == undefined)
                    color = "light";
                setColor(color);
                setColorChecked(color);
